...
VSPresetFormat get_vs_output_pixel_format( const char *format_name )
{
    ...
    fprintf( stderr, "lsmas: unable to recognize format \"%s\", ignored.\n", format_name );
    return pfNone;
}
...
)
{
    ...
    static const struct
    {
    ...
    } conversion_table[] =
        {
            ...
            { AV_PIX_FMT_XV30LE,       pfYUV444P10, 1 },
            { AV_PIX_FMT_XV30BE,       pfYUV444P10, 1 },
            { AV_PIX_FMT_YUV420P12LE,  pfYUV420P12, 0 },
            { AV_PIX_FMT_YUV420P12BE,  pfYUV420P12, 1 },
            { AV_PIX_FMT_P012LE,       pfYUV420P12, 1 },
            ...
            { AV_PIX_FMT_XV36BE,       pfYUV444P12, 1 },
